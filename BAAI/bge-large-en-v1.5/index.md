...
- [README.md](https://paddlenlp.bj.bcebos.com/models/community/BAAI/bge-large-en-v1.5/README.md) (92.4 KB)

- [config.json](https://paddlenlp.bj.bcebos.com/models/community/BAAI/bge-large-en-v1.5/config.json) (779.0 B)

- [model_state.pdparams](https://paddlenlp.bj.bcebos.com/models/community/BAAI/bge-large-en-v1.5/model_state.pdparams) (1.2 GB)

- [special_tokens_map.json](https://paddlenlp.bj.bcebos.com/models/community/BAAI/bge-large-en-v1.5/special_tokens_map.json) (125.0 B)

- [tokenizer.json](https://paddlenlp.bj.bcebos.com/models/community/BAAI/bge-large-en-v1.5/tokenizer.json) (694.7 KB)

- [tokenizer_config.json](https://paddlenlp.bj.bcebos.com/models/community/BAAI/bge-large-en-v1.5/tokenizer_config.json) (366.0 B)

- [vocab.txt](https://paddlenlp.bj.bcebos.com/models/community/BAAI/bge-large-en-v1.5/vocab.txt) (226.1 KB)
