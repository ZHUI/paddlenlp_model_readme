...
## README([From Huggingface](https://huggingface.co/ClueAI/ChatYuan-large-v2))
...
def answer(text, sample=True, top_p=1, temperature=0.7):
  ...
  encoding = tokenizer(text=[text], truncation=True, padding=True, max_length=512, return_tensors="pd") 
  if not sample:
...
- [README.md](https://paddlenlp.bj.bcebos.com/models/community/ClueAI/ChatYuan-large-v2/README.md) (24.7 KB)

- [config.json](https://paddlenlp.bj.bcebos.com/models/community/ClueAI/ChatYuan-large-v2/config.json) (838.0 B)

- [generation_config.json](https://paddlenlp.bj.bcebos.com/models/community/ClueAI/ChatYuan-large-v2/generation_config.json) (147.0 B)

- [model_state.pdparams](https://paddlenlp.bj.bcebos.com/models/community/ClueAI/ChatYuan-large-v2/model_state.pdparams) (3.2 GB)

- [pytorch_model.bin](https://paddlenlp.bj.bcebos.com/models/community/ClueAI/ChatYuan-large-v2/pytorch_model.bin) (1.5 GB)

- [special_tokens_map.json](https://paddlenlp.bj.bcebos.com/models/community/ClueAI/ChatYuan-large-v2/special_tokens_map.json) (1.7 KB)

- [spiece.model](https://paddlenlp.bj.bcebos.com/models/community/ClueAI/ChatYuan-large-v2/spiece.model) (724.7 KB)

- [tokenizer_config.json](https://paddlenlp.bj.bcebos.com/models/community/ClueAI/ChatYuan-large-v2/tokenizer_config.json) (1.9 KB)
