...
## README([From Huggingface](https://huggingface.co/OpenGVLab/InternVL2-2B))
...
| :--------------------------: | :----------: | :------------------: | :----------: |
|          Model Size          |     2.9B     |         2.2B         |     2.2B     |
|                              |              |                      |              |
|    DocVQA<sub>test</sub>     |      -       |         85.0         |     86.9     |
|    ChartQA<sub>test</sub>    |      -       |         74.8         |     76.2     |
|    InfoVQA<sub>test</sub>    |      -       |         55.4         |     58.9     |
|    TextVQA<sub>val</sub>     |     68.1     |         70.5         |     73.4     |
|           OCRBench           |     614      |         654          |     784      |
|      MME<sub>sum</sub>       |    1686.1    |        1901.5        |    1876.8    |
|         RealWorldQA          |     55.2     |         57.9         |     57.3     |
|     AI2D<sub>test</sub>      |     68.3     |         69.8         |     74.1     |
|      MMMU<sub>val</sub>      |     34.9     |         37.4         |     36.3     |
|  MMBench-EN<sub>test</sub>   |     71.0     |         70.9         |     73.2     |
|  MMBench-CN<sub>test</sub>   |     63.6     |         66.2         |     70.9     |
|    CCBench<sub>dev</sub>     |     29.6     |         63.5         |     74.7     |
|  MMVet<sub>GPT-4-0613</sub>  |      -       |         39.3         |     44.6     |
| MMVet<sub>GPT-4-Turbo</sub>  |     33.1     |         35.5         |     39.5     |
|          SEED-Image          |     69.6     |         69.8         |     71.6     |
|   HallBench<sub>avg</sub>    |     32.2     |         37.5         |     37.9     |
| MathVista<sub>testmini</sub> |     28.7     |         41.1         |     46.3     |
|  OpenCompass<sub>avg</sub>   |     46.6     |         49.8         |     54.0     |
...
- [README.md](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2-2B/README.md) (33.8 KB)

- [added_tokens.json](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2-2B/added_tokens.json) (179.0 B)

- [config.json](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2-2B/config.json) (3.6 KB)

- [generation_config.json](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2-2B/generation_config.json) (69.0 B)

- [model_state.pdparams](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2-2B/model_state.pdparams) (4.1 GB)

- [preprocessor_config.json](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2-2B/preprocessor_config.json) (287.0 B)

- [special_tokens_map.json](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2-2B/special_tokens_map.json) (844.0 B)

- [tokenizer.model](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2-2B/tokenizer.model) (1.4 MB)

- [tokenizer_config.json](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2-2B/tokenizer_config.json) (3.5 KB)
