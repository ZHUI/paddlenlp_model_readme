...
## README([From Huggingface](https://huggingface.co/OpenGVLab/InternVL2_5-2B-MPO))
...
```shell
lmdeploy serve api_server OpenGVLab/InternVL2_5-2B-MPO --server-port 23333
```
...
- [README.md](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2_5-2B-MPO/README.md) (32.3 KB)

- [added_tokens.json](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2_5-2B-MPO/added_tokens.json) (179.0 B)

- [config.json](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2_5-2B-MPO/config.json) (3.9 KB)

- [configuration_intern_vit.py](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2_5-2B-MPO/configuration_intern_vit.py) (5.4 KB)

- [configuration_internlm2.py](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2_5-2B-MPO/configuration_internlm2.py) (6.8 KB)

- [configuration_internvl_chat.py](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2_5-2B-MPO/configuration_internvl_chat.py) (3.8 KB)

- [conversation.py](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2_5-2B-MPO/conversation.py) (15.0 KB)

- [generation_config.json](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2_5-2B-MPO/generation_config.json) (115.0 B)

- [model.safetensors](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2_5-2B-MPO/model.safetensors) (4.1 GB)

- [modeling_intern_vit.py](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2_5-2B-MPO/modeling_intern_vit.py) (17.6 KB)

- [modeling_internlm2.py](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2_5-2B-MPO/modeling_internlm2.py) (59.8 KB)

- [modeling_internvl_chat.py](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2_5-2B-MPO/modeling_internvl_chat.py) (15.3 KB)

- [preprocessor_config.json](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2_5-2B-MPO/preprocessor_config.json) (287.0 B)

- [special_tokens_map.json](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2_5-2B-MPO/special_tokens_map.json) (844.0 B)

- [tokenization_internlm2.py](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2_5-2B-MPO/tokenization_internlm2.py) (8.6 KB)

- [tokenization_internlm2_fast.py](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2_5-2B-MPO/tokenization_internlm2_fast.py) (7.6 KB)

- [tokenizer.model](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2_5-2B-MPO/tokenizer.model) (1.4 MB)

- [tokenizer_config.json](https://paddlenlp.bj.bcebos.com/models/community/OpenGVLab/InternVL2_5-2B-MPO/tokenizer_config.json) (3.9 KB)
