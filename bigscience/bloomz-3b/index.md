...
## README([From Huggingface](https://huggingface.co/bigscience/bloomz-3b))
...
- [README.md](https://paddlenlp.bj.bcebos.com/models/community/bigscience/bloomz-3b/README.md) (24.0 KB)

- [config.json](https://paddlenlp.bj.bcebos.com/models/community/bigscience/bloomz-3b/config.json) (745.0 B)

- [merges.txt](https://paddlenlp.bj.bcebos.com/models/community/bigscience/bloomz-3b/merges.txt) (4.0 MB)

- [model_state.pdparams](https://paddlenlp.bj.bcebos.com/models/community/bigscience/bloomz-3b/model_state.pdparams) (5.6 GB)

- [pytorch_model.bin](https://paddlenlp.bj.bcebos.com/models/community/bigscience/bloomz-3b/pytorch_model.bin) (5.6 GB)

- [special_tokens_map.json](https://paddlenlp.bj.bcebos.com/models/community/bigscience/bloomz-3b/special_tokens_map.json) (96.0 B)

- [tokenizer.json](https://paddlenlp.bj.bcebos.com/models/community/bigscience/bloomz-3b/tokenizer.json) (13.8 MB)

- [tokenizer_config.json](https://paddlenlp.bj.bcebos.com/models/community/bigscience/bloomz-3b/tokenizer_config.json) (254.0 B)

- [vocab.json](https://paddlenlp.bj.bcebos.com/models/community/bigscience/bloomz-3b/vocab.json) (6.3 MB)
