...
## README([From Huggingface](https://huggingface.co/bigscience/mt0-base))
...
- [README.md](https://paddlenlp.bj.bcebos.com/models/community/bigscience/mt0-base/README.md) (23.3 KB)

- [config.json](https://paddlenlp.bj.bcebos.com/models/community/bigscience/mt0-base/config.json) (798.0 B)

- [pytorch_model.bin](https://paddlenlp.bj.bcebos.com/models/community/bigscience/mt0-base/pytorch_model.bin) (2.2 GB)

- [special_tokens_map.json](https://paddlenlp.bj.bcebos.com/models/community/bigscience/mt0-base/special_tokens_map.json) (74.0 B)

- [tokenizer.json](https://paddlenlp.bj.bcebos.com/models/community/bigscience/mt0-base/tokenizer.json) (15.6 MB)

- [tokenizer_config.json](https://paddlenlp.bj.bcebos.com/models/community/bigscience/mt0-base/tokenizer_config.json) (430.0 B)
