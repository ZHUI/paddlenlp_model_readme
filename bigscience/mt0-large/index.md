...
## README([From Huggingface](https://huggingface.co/bigscience/mt0-large))
...
- [README.md](https://paddlenlp.bj.bcebos.com/models/community/bigscience/mt0-large/README.md) (23.3 KB)

- [config.json](https://paddlenlp.bj.bcebos.com/models/community/bigscience/mt0-large/config.json) (800.0 B)

- [pytorch_model.bin](https://paddlenlp.bj.bcebos.com/models/community/bigscience/mt0-large/pytorch_model.bin) (4.6 GB)

- [special_tokens_map.json](https://paddlenlp.bj.bcebos.com/models/community/bigscience/mt0-large/special_tokens_map.json) (74.0 B)

- [tokenizer.json](https://paddlenlp.bj.bcebos.com/models/community/bigscience/mt0-large/tokenizer.json) (15.6 MB)

- [tokenizer_config.json](https://paddlenlp.bj.bcebos.com/models/community/bigscience/mt0-large/tokenizer_config.json) (430.0 B)
