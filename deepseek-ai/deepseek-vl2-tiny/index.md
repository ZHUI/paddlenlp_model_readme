...
## README([From Huggingface](https://huggingface.co/deepseek-ai/deepseek-vl2-tiny))
...
- [README.md](https://paddlenlp.bj.bcebos.com/models/community/deepseek-ai/deepseek-vl2-tiny/README.md) (5.7 KB)

- [config.json](https://paddlenlp.bj.bcebos.com/models/community/deepseek-ai/deepseek-vl2-tiny/config.json) (2.2 KB)

- [model-00001-of-000001.safetensors](https://paddlenlp.bj.bcebos.com/models/community/deepseek-ai/deepseek-vl2-tiny/model-00001-of-000001.safetensors) (6.3 GB)

- [model.safetensors.index.json](https://paddlenlp.bj.bcebos.com/models/community/deepseek-ai/deepseek-vl2-tiny/model.safetensors.index.json) (241.5 KB)

- [processor_config.json](https://paddlenlp.bj.bcebos.com/models/community/deepseek-ai/deepseek-vl2-tiny/processor_config.json) (1.2 KB)

- [special_tokens_map.json](https://paddlenlp.bj.bcebos.com/models/community/deepseek-ai/deepseek-vl2-tiny/special_tokens_map.json) (801.0 B)

- [tokenizer.json](https://paddlenlp.bj.bcebos.com/models/community/deepseek-ai/deepseek-vl2-tiny/tokenizer.json) (6.0 MB)

- [tokenizer_config.json](https://paddlenlp.bj.bcebos.com/models/community/deepseek-ai/deepseek-vl2-tiny/tokenizer_config.json) (161.3 KB)
