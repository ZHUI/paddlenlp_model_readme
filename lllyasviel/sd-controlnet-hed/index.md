...
## README([From Huggingface](https://huggingface.co/lllyasviel/sd-controlnet-hed))
...
![![img](https://huggingface.co/lllyasviel/sd-controlnet-hed/resolve/main/./sd.png)
...
controlnet = ControlNetModel.from_pretrained(
    "lllyasviel/sd-controlnet-hed", dtype=paddle.float16
)
...
![![man](https://huggingface.co/lllyasviel/sd-controlnet-hed/resolve/main/./images/man.png)

![![man_hed](https://huggingface.co/lllyasviel/sd-controlnet-hed/resolve/main/./images/man_hed.png)

![![man_hed_out](https://huggingface.co/lllyasviel/sd-controlnet-hed/resolve/main/./images/man_hed_out.png)
...
- [README.md](https://paddlenlp.bj.bcebos.com/models/community/lllyasviel/sd-controlnet-hed/README.md) (11.2 KB)

- [config.json](https://paddlenlp.bj.bcebos.com/models/community/lllyasviel/sd-controlnet-hed/config.json) (967.0 B)

- [model_state.pdparams](https://paddlenlp.bj.bcebos.com/models/community/lllyasviel/sd-controlnet-hed/model_state.pdparams) (1.3 GB)
