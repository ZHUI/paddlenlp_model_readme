...
## README([From Huggingface](https://huggingface.co/lllyasviel/sd-controlnet-mlsd))
...
![![img](https://huggingface.co/lllyasviel/sd-controlnet-mlsd/resolve/main/./sd.png)
...
controlnet = ControlNetModel.from_pretrained(
    "lllyasviel/sd-controlnet-mlsd", dtype=paddle.float16
)
...
![![room](https://huggingface.co/lllyasviel/sd-controlnet-mlsd/resolve/main/./images/room.png)

![![room_mlsd](https://huggingface.co/lllyasviel/sd-controlnet-mlsd/resolve/main/./images/room_mlsd.png)

![![room_mlsd_out](https://huggingface.co/lllyasviel/sd-controlnet-mlsd/resolve/main/./images/room_mlsd_out.png)
...
- [README.md](https://paddlenlp.bj.bcebos.com/models/community/lllyasviel/sd-controlnet-mlsd/README.md) (11.3 KB)

- [config.json](https://paddlenlp.bj.bcebos.com/models/community/lllyasviel/sd-controlnet-mlsd/config.json) (1011.0 B)

- [model_state.pdparams](https://paddlenlp.bj.bcebos.com/models/community/lllyasviel/sd-controlnet-mlsd/model_state.pdparams) (1.3 GB)
