...
## README([From Huggingface](https://huggingface.co/qwen/qwen-1_8b-chat))
...
# use bf16
# model = AutoModelForCausalLM.from_pretrained("Qwen/Qwen-1_8B-Chat",  trust_remote_code=True, bf16=True).eval()
# use fp16
# model = AutoModelForCausalLM.from_pretrained("Qwen/Qwen-1_8B-Chat",  trust_remote_code=True, fp16=True).eval()
# use cpu only
...
- [README.md](https://paddlenlp.bj.bcebos.com/models/community/qwen/qwen-1_8b-chat/README.md) (26.0 KB)

- [chat_template.json](https://paddlenlp.bj.bcebos.com/models/community/qwen/qwen-1_8b-chat/chat_template.json) (270.0 B)

- [config.json](https://paddlenlp.bj.bcebos.com/models/community/qwen/qwen-1_8b-chat/config.json) (802.0 B)

- [generation_config.json](https://paddlenlp.bj.bcebos.com/models/community/qwen/qwen-1_8b-chat/generation_config.json) (225.0 B)

- [model_state.pdparams](https://paddlenlp.bj.bcebos.com/models/community/qwen/qwen-1_8b-chat/model_state.pdparams) (3.4 GB)

- [qwen.tiktoken](https://paddlenlp.bj.bcebos.com/models/community/qwen/qwen-1_8b-chat/qwen.tiktoken) (2.4 MB)

- [tokenizer_config.json](https://paddlenlp.bj.bcebos.com/models/community/qwen/qwen-1_8b-chat/tokenizer_config.json) (121.0 B)
