...
## README([From Huggingface](https://huggingface.co/qwen/qwen-7b-chat))
...
# use bf16
# model = AutoModelForCausalLM.from_pretrained("Qwen/Qwen-7B-Chat",  trust_remote_code=True, bf16=True).eval()
# use fp16
# model = AutoModelForCausalLM.from_pretrained("Qwen/Qwen-7B-Chat",  trust_remote_code=True, fp16=True).eval()
# use cpu only
...
![![](https://huggingface.co/qwen/qwen-7b-chat/resolve/main/assets/react_showcase_001.png)
![![](https://huggingface.co/qwen/qwen-7b-chat/resolve/main/assets/react_showcase_002.png)
...
- [README.md](https://paddlenlp.bj.bcebos.com/models/community/qwen/qwen-7b-chat/README.md) (34.8 KB)

- [chat_template.json](https://paddlenlp.bj.bcebos.com/models/community/qwen/qwen-7b-chat/chat_template.json) (270.0 B)

- [config.json](https://paddlenlp.bj.bcebos.com/models/community/qwen/qwen-7b-chat/config.json) (766.0 B)

- [generation_config.json](https://paddlenlp.bj.bcebos.com/models/community/qwen/qwen-7b-chat/generation_config.json) (219.0 B)

- [model.safetensors](https://paddlenlp.bj.bcebos.com/models/community/qwen/qwen-7b-chat/model.safetensors) (14.4 GB)

- [model_state.pdparams](https://paddlenlp.bj.bcebos.com/models/community/qwen/qwen-7b-chat/model_state.pdparams) (14.4 GB)

- [qwen.tiktoken](https://paddlenlp.bj.bcebos.com/models/community/qwen/qwen-7b-chat/qwen.tiktoken) (2.4 MB)

- [tokenizer_config.json](https://paddlenlp.bj.bcebos.com/models/community/qwen/qwen-7b-chat/tokenizer_config.json) (121.0 B)

- [tokenizer_config_orig.json](https://paddlenlp.bj.bcebos.com/models/community/qwen/qwen-7b-chat/tokenizer_config_orig.json) (78.0 B)
